...
// Create a class Person with name and age. Derive a class Student from Person
// that adds roll number and display function. Show how the derived class
// inherits and extends the base class. (Person<-Student)
#include <iostream>
#include <string>
using namespace std;
